...
const Projects = () => {
    ...
    const ProjectsData = [
      ...
      },
      {
        id: 4,
        image: projectImage,
        title: 'Thermodynamic modelling of Gas hydrates using ML tools',
        projectdescription: "• created a machine learning model that can predict the conditions under which gas hydrates will form, dissociate,or remain stable",
        link:"https://github.com/Sathvik145",
    },
    {
      id: 4,
      image: ipl,
      title: '•IPL Win Predictor',
      projectdescription: "• Machine learing model to predict the probability of winning of a team in the 2nd innings with the current situationdetails like target score,current score,number of overs completed,number of wickets down.",
      link:"https://github.com/Sathvik145/ipl-win-predictor",
  }
    ]
  return (
    <div name="Projects" className='bg-gradient-to-b from-black to-gray-800 w-full '>
      <div className='max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full text-white'>
        ...
        <div className='w-full grid grid-cols-1 sm:grid-cols-1 gap-8 text-center py-8 px-12 sm:px-0'>
            {ProjectsData.map(({id, image, title, projectdescription, link}) => (
